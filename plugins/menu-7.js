 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya SKY BOT ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 SKY - BOT"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 SKY - BOT..."},
	]
    },{
	...
	{title: `⫹🍭 › 𐐪-〚 Thanks To 〛-𐑂`, rowId: ".? thnks", description: "╰► Contributor SKY BOT -𐑂"},
